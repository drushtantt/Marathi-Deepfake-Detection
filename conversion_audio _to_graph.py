!pip install librosa networkx torch torch-geometric
...
# Example usage
input_path = '/kaggle/input/path_to_audio_files/'  # Update this path to your input directory
...
for audio_file in audio_files:
    ...
    # Save the processed graph data to the output directory (optional)
    torch.save(torch_data, os.path.join(output_path, f'{audio_file.stem}_graph.pt'))
